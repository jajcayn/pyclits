...
def figures2d_TE(dataset, selector, title, xlabel, ylabel, filename, suffix, cmap="rainbow", dpi=300):
    matplotlib.style.use("seaborn")
...
def figures2d_TE_errorbar(dataset, selector, error_selector, title, xlabel, ylabel, filename, suffix, view=(70, 120), cmap="rainbow", dpi=300):
    matplotlib.style.use("seaborn")
